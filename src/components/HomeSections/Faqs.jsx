    ...
    return (
        ...
        <>
            ...
            <div className=' flex justify-center'>
                ...
                <div className='w-[60%] ' id="accordion-collapse" data-accordion="collapse">
                    {accordionItems.map((item, index) => (
                        <div key={index}>
                            <h2 id={`accordion-collapse-heading-${index + 1}`}>
                                <button
                                    type="button"
                                    className={`flex items-center justify-between w-full p-5 font-medium rtl:text-right text-gray-500 border border-b-0 border-gray-200 rounded-t-xl focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-800 dark:border-gray-700 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 gap-3 ${activeAccordion === index ? 'active' : ''
                                        }`}
                            ...
                            <div
                                ...
                                className={`p-5 border border-b-0 border-gray-200 dark:border-gray-700 ${activeAccordion === index ? 'block' : 'hidden'
                                    }`}
