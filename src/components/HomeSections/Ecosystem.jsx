        ...
        <>
            <div id="eco-main" className="flex gap-20 flex-col bg-cover min-h-screen bg-no-repeat   bg-left bg-[url(/ecosystem.png)] items-center justify-center my-20">
                ...
                <div className="flex flex-wrap justify-center items-center gap-28 laptop:gap-10 " >
                    ...
                    <div className="brradis max-w-[352px] h-[348.53px] origin-top-left   bg-blue-400  bg-opacity-10 rounded-[30px] border-2   " >
                        ...
                        <div className="flex gap-5 px-3 py-10 justify-center items-center flex-col">
                            ...
                            <div className="text-4xl text-center">
                                <h3>Stake and Earn Rewards </h3>
                            </div>
                            <div className=" text-center" >
                                Token holders can stake their VOIP tokens to secure the network and earn rewards in return for their participation.
                            </div>
                        </div>
                    </div>
